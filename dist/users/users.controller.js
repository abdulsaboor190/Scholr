...
], SavePushTokenDto.prototype, "pushToken", void 0);
let UsersController = class UsersController {
    ...
    savePushToken(userId, dto) {
        return this.usersService.savePushToken(userId, dto.pushToken);
    }
    async uploadAvatar(userId, file) {
        const result = await this.cloudinaryService.uploadImage(file, 'scholr/avatars');
...
__decorate([
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, SavePushTokenDto]),
    __metadata("design:returntype", void 0)
